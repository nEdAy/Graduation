...
using wool.Model;
namespace wool.BLL{
public partial class weiboBLL{
/// <summary>
/// 数据库操作对象
/// </summary>
private weiboDAO _dao = new weiboDAO();
...
public IEnumerable<weibo> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +weibo QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
