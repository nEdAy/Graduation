...
/// 数据库操作对象
/// </summary>
private WithdrawalsDetailsDAO _dao = new WithdrawalsDetailsDAO();
#region 向数据库中添加一条记录 +bool; Insert(WithdrawalsDetails model)
/// <summary>
/// 向数据库中添加一条记录
/// </summary>
...
#endregion
#region 根据主键ID更新一条记录 +bool Update(WithdrawalsDetails model)
/// <summary>
/// 根据主键更新一条记录
/// </summary>
...
public IEnumerable<WithdrawalsDetails> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +WithdrawalsDetails QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
...
#endregion
#region 查询单个模型实体 +WithdrawalsDetails QuerySingleById(string objectId)
///<summary>
///查询单个模型实体
///</summary>
