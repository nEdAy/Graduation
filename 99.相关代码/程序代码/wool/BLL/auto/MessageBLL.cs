...
#region 向数据库中添加一条记录 +bool; Insert(Message model)
/// <summary>
/// 向数据库中添加一条记录
/// </summary>
...
#endregion
#region 根据主键ID更新一条记录 +bool Update(Message model)
/// <summary>
/// 根据主键更新一条记录
/// </summary>
...
public IEnumerable<Message> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +Message QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
///<returns>实体</returns>
public Message QuerySingleByWheres(object wheres)
{
...
#endregion
#region 查询单个模型实体 +Message QuerySingleById(string objectId)
///<summary>
///查询单个模型实体
///</summary>
