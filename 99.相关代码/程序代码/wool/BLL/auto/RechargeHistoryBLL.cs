...
using wool.Model;
namespace wool.BLL{
public partial class RechargeHistoryBLL{
/// <summary>
/// 数据库操作对象
/// </summary>
private RechargeHistoryDAO _dao = new RechargeHistoryDAO();
#region 向数据库中添加一条记录 +bool; Insert(RechargeHistory model)
/// <summary>
/// 向数据库中添加一条记录
/// </summary>
...
#endregion
#region 根据主键ID更新一条记录 +bool Update(RechargeHistory model)
/// <summary>
/// 根据主键更新一条记录
/// </summary>
...
public IEnumerable<RechargeHistory> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +RechargeHistory QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
...
#endregion
#region 查询单个模型实体 +RechargeHistory QuerySingleById(string objectId)
///<summary>
///查询单个模型实体
///</summary>
