...
/// 数据库操作对象
/// </summary>
private ActivityDAO _dao = new ActivityDAO();
...
public IEnumerable<Activity> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +Activity QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
