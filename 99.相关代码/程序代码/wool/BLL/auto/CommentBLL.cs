...
#region 向数据库中添加一条记录 +bool; Insert(Comment model)
/// <summary>
/// 向数据库中添加一条记录
/// </summary>
...
#endregion
#region 根据主键ID更新一条记录 +bool Update(Comment model)
/// <summary>
/// 根据主键更新一条记录
/// </summary>
...
public IEnumerable<Comment> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +Comment QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
...
#endregion
#region 查询单个模型实体 +Comment QuerySingleById(string objectId)
///<summary>
///查询单个模型实体
///</summary>
